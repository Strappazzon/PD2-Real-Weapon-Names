...
Hooks:PostHook( EconomyTweakData , "create_weapon_skin_market_search_url" , "RWN_EconomyTweakDataPostCreateWeaponSkinMarketSearchUrl" , function( self , weapon_id, cosmetic_id )
	...
	local weapon_name = managers.localization:text(tweak_data.weapon[weapon_id].name_id .. "__BACKUP")
